...
const Login = () => {
    ...
    const naver_redirect_uri = process.env.REACT_APP_NAVER_REDIRECT_URI //Redirect URI
    const state = 1234;
    ...
    const google_redirect_uri = process.env.REACT_APP_GOOGLE_REDIRECT_URI //Redirect URI
    // const state = 1234;
